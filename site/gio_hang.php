...
<body class="m-0 p-0 box-border">
    <div class="mx-[10px] max-w-[1440px] mx-auto">
        <section class="bg-[#253796] flex justify-around ">
            ...
            <section class="mt-[115px] mb-[200px]">
                <div class="flex text-[32px] space-x-12 border-4 border-black mb-[50px]">
                    <a href=""><p class="ml-[73px] border-r-4 border-black pr-[50px] hover:text-orange-400">GIỎ HÀNG</p></a>
                    <a href=""><p class="hover:text-orange-400">LỊCH SỬ MUA HÀNG</p></a>
                </div>
                <h2 class="text-[48px] mb-[25px] ml-[100px]">GIỎ HÀNG</h2>
                <input type="text" name="" id="" class="border-2 border-black w-[1200px] h-[60px] ml-[80px]">
            </section>
                ...
                <div class="flex justify-around py-[50px]">
                    ...
                    <div class="bg-[#DC1212] w-[271px] h-[135px] rounded-[20px]">
                        ...
                        <div class="flex space-x-7 -mt-[35px] ml-[10px]">
                            <img src="upload/img/ap.png" alt="">
                            <img src="upload/img/gg.png" alt="">
                        </div>
                    </div>
                </div>
            </section>
