    ...
    <div class="mx-[10px] max-w-[1440px] mx-auto">
        <section class="bg-[#253796] flex justify-around ">
            ...
            <section class="text-[40px] font-bold">
                <h3 class="mt-[70px] mb-[70px] text-center">Đăng nhập hệ thống</h3>
                <form action="" class="text-center">
                    <legend class="mb-[40px] mr-[720px]">Tài khoản</legend>
                    <input type="text" value="Tài khoản" class="bg-[#D9D9D9] w-[897px] h-[100px] pl-[60px] ">
                    <legend class="my-[40px] mr-[720px]">Mật khẩu</legend>
                    <input type="text" value="Mật khẩu" class="bg-[#D9D9D9] w-[897px] h-[100px] pl-[60px] ">
                    <a href=""><p class="my-[20px] mr-[610px] text-[#1A56CA]">Quên Mật khẩu</p></a>
                    <input type="submit" value="Đăng nhập" class="bg-[#DF1A0D] w-[336px] h-[78px] rounded-[10px] text-[30px] mr-[560px] text-white">
                </form>
                <div class="flex space-x-2 ml-[268px] mt-[22px] mb-[70px]">
                    <p>Bạn chưa có tài khoản?</p>
                    <a href=""><p class="text-[#1A56CA]">Đăng ký</p></a>
                </div>
            </section>
